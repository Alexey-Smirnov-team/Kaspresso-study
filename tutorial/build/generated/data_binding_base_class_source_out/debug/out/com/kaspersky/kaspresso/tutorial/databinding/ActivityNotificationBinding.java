...
public final class ActivityNotificationBinding implements ViewBinding {
  ...
  @NonNull
  public final Button showNotificationButton;

  private ActivityNotificationBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button showNotificationButton) {
  ...
  public static ActivityNotificationBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.show_notification_button;
      Button showNotificationButton = ViewBindings.findChildViewById(rootView, id);
      if (showNotificationButton == null) {
        break missingId;
      }

      return new ActivityNotificationBinding((ConstraintLayout) rootView, showNotificationButton);
    }
